# -*- coding: utf-8 -*-
"""
Created on Tue Feb 15 00:30:18 2022
...
for i in range(len(contours)):
    ...
    #external
    if hierarch[0][i][3] == -1:
        cv2.drawContours(external_contour, contours, i, 255, -1) #255 renk *1 ise kalınlık -1 ise kontürlerle sınırlanan alanı doldur
    else: 
